                        ...
                        <div className="mb-10 lg:order-1 lg:w-2/4 xl:w-[30%]">
                            <div className="text-center lg:text-left text-lg">
                                <h2 className="mb-6 font-display text-xl text-jacarta-700 dark:text-white lg:pr-4">
                                    ...
                                    <span className="text-jacarta-300">to track your NFT portfolio and discover drops</span>
                                </h2>
                        ...
                        <div className="mb-10 hidden lg:order-3 lg:block lg:w-2/4 xl:w-[30%]">
                            <div className="flex items-center space-x-8 lg:pl-6">
                                ...
                                <div className="text-left">
                                    ...
                                    <span className="text-lg text-jacarta-700 dark:text-white">Scan to download Xhibiter app</span>
                                </div>
                            </div>
                        </div>
                        {/*scan downaload app */}
