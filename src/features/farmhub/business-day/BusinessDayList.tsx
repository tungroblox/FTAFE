                ...
                columns={[
...

                    {
                        ...
                        render: ({ ...props }: BusinessDay) => {
                            return <p>{moment(props.regiterDay).format('DD/MM/YYYY')}</p>;
                        },
                    },
                    {
                        ...
                        key: 'endOfRegister',
                        render: ({ ...props }: BusinessDay) => {
                            return <p>{moment(props.endOfRegister).format('DD/MM/YYYY')}</p>;
                        },
                    },
                    {
                        ...
                        key: 'openDay',
                        render: ({ ...props }: BusinessDay) => {
                            return <p>{moment(props.openDay).format('DD/MM/YYYY')}</p>;
                        },
                    },
                    {
                        ...
                        render: ({ ...props }: BusinessDay) => {
                            ...
                            return (
                                <Button
                                    type="primary"
                                    onClick={() => {
                                        router.push(`/farmhub/business-day/${props.id}`);
                                    }}
                                >
                                    Xem chi tiết
                                </Button>
